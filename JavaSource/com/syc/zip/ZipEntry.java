...
private static final Logger log = Logger.getLogger(ZipEntry.class);
...
// Se comenta el codigo, pues no parece tener una utilidad en el proyecto, y causa dependencias deprecadas de sun.
//que complican la portabilidad, si se tiene problemas con operacion con Zips files descomentar.
/*	static {
	...
	public void setComment(String comment) {
		...
		if (comment != null
			&& comment.length() > 0xffff / 3
			&& ZipOutputStream.getEncodedBytesLength(comment) > 0xffff) {
	...
	public Object clone() {
		try {
			...
			return e;
		} catch (CloneNotSupportedException e) {	log.error(e,e);
