...
<!-- /Extras:Extjs -->
<!-- Aplicacion:Extjs -->
<link rel="stylesheet" type="text/css" href="../css/GavetasCampos.css" />
<script type="text/javascript" src="../js/GavetasCampos.js"></script>
<!-- /Aplicacion:Extjs -->
...
var context_title = 'Gaveta'; 				//Texto del contexto del grid pj. "Gavetas" , "Usuarios" etc.
