...
<title>Configura Variables de Correo</title>
<!-- Framework:Extjs -->
...
<!-- /Framework:Extjs -->
<!-- Aplicacion:Extjs -->
<script src="../js/ConfiguraCorreo.js" type="text/JavaScript"></script>
<link rel="stylesheet" type="text/css" href="../css/ConfiguraCorreo.css" />
<!-- /Aplicacion:Extjs -->
<% 
