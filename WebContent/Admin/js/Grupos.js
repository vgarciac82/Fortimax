Ext.onReady(function(){
	...
	var nombreIndex='nombreGrupo';
	var actionStore="getGrupos";
	var tituloGrid="Grupos";
	var tituloField="Grupos";
	var tituloPanel="Grupos";
	var tituloBtnCrear="Grupo";
	var ancho=500;
	var txtLabelFilas='Grupos';
	var root='grupos';
	var link_btncreate=basePath+'/Admin/jsp/GruposCrear.jsp?actualizar=false';
	var accionDescargar="getReport";
	/*
	 * Variables de Columnas
	 */
	var columnaActualizar='Actualizar';
	var linkActionColumnActualizar=basePath+"/Admin/jsp/GruposCrear.jsp?actualizar=true&nombre_grupo=";
	var columnaPrivilegios='Privilegios';
	var linkActionColumnPrivilegios=basePath+"/Admin/jsp/UsuariosPrivilegios.jsp?aGrupo=true&Grupo=";
	...
	var labelFilas=new Ext.form.Label({
 		...
 		var btnDescargar = new Ext.ux.DownloadButton({
 		    ...
 		    select:'imx_grupo',
 		    nombreReporte:'Reporte Grupos',
 		    columnaBuscar:'NOMBRE_GRUPO',
 		    Filtro:'txtFiltro',
