Ext.onReady(function(){
	...
	var tituloColumna="Gavetas";
	var nombreIndex='Nombre';
	var actionStore="listgavetas";
	var tituloGrid="Gavetas";
	var tituloField="Gavetas";
	var tituloPanel="Gavetas";
	var tituloBtnCrear="Gaveta";
	var ancho=500;
	var txtLabelFilas='Gavetas';
	var root='catalog';
	var link_btncreate=basePath+'/Admin/jsp/GavetasCampos.jsp';
	var accionDescargar="getReport";
	/*
	 * Variables de Columnas
	 */
	var columnaActualizar='Actualizar';
	var linkActionColumnActualizar=basePath+"/Admin/jsp/GavetasCampos.jsp?action=getgaveta&select=";
    ...
    select:'imx_aplicacion',
    nombreReporte:'Reporte Gavetas',
    columnaBuscar:'TITULO_APLICACION',
    Filtro:'txtFiltro',
	...
	function Eliminar(Nombre){
		Ext.Msg.show({
		     title:'Eliminar',
		     msg: '&iquestDeseas eliminar la gaveta: '+Nombre+' ?',
