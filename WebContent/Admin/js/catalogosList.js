Ext.onReady(function(){
	...
	var tituloColumna="Catalogos";
	var nombreIndex='Nombre';
	var actionStore="listcatalogos";
	var tituloGrid="Catalogos";
	var tituloField="Catalogos";
	var tituloPanel="Catalogos";
	var tituloBtnCrear="Catalogo";
	var ancho=500;
	var txtLabelFilas='Catalogos';
	var root='catalog';
	var link_btncreate=basePath+'/Admin/jsp/catalogos.jsp';
	var accionDescargar="getReport";
	/*
	 * Variables de Columnas
	 */
	var columnaActualizar='Actualizar';
	var linkActionColumnActualizar=basePath+"/Admin/jsp/catalogos.jsp?NombreCatalogo=";
	...
	var labelFilas=new Ext.form.Label({
 	...
 	var btnDescargar = new Ext.ux.DownloadButton({
 		    ...
 		    select:'imx_catalogo',
 		    nombreReporte:'Reporte Catalogos',
 		    columnaBuscar:'NOMBRE_CATALOGO',
 		    Filtro:'txtFiltro',
	...
	function Eliminar(Nombre){
		Ext.Msg.show({
		     title:'Eliminar',
		     msg: '&iquestDeseas eliminar el catalogo: '+Nombre+' ?',
