Ext.onReady(function(){
	...
	var tituloColumna="Usuarios";
	var nombreIndex='Nombre';
	var actionStore="listusuarios";
	var tituloGrid="Usuarios";
	var tituloField="Usuarios";
	var tituloPanel="Usuarios";
	var tituloBtnCrear="Usuario";
	var ancho=500;
	var txtLabelFilas='Usuarios';
	var root='catalog';
	var link_btncreate=basePath+'/Admin/jsp/UsuariosCrear.jsp';
	var accionDescargar="getReport";
	/*
	 * Variables de Columnas
	 */
	var columnaActualizar='Actualizar';
	var linkActionColumnActualizar=basePath+"/Admin/jsp/UsuariosCrear.jsp?actualizar=true&nombre_usuario=";
	var columnaPrivilegios='Privilegios';
	var linkActionColumnPrivilegios=basePath+"/Admin/jsp/UsuariosPrivilegios.jsp?nombre_usuario=";
	...
	function Eliminar(Nombre){
		Ext.Msg.show({
		     title:'Eliminar',
		     msg: '&iquestDeseas eliminar el usuario: '+Nombre+' ?',
