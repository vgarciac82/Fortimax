Ext.onReady(function(){
	...
	var tituloColumna="Plantillas";
	var nombreIndex='Nombre';
	var actionStore="getDocumentos";
	var tituloGrid="Plantillas";
	var tituloField="Plantillas";
	var tituloPanel="Plantillas";
	var tituloBtnCrear="Plantilla";
	var ancho=500;
	var txtLabelFilas='Plantillas';
	var root='documentos';
	var link_btncreate=basePath+'/Admin/jsp/documentosCrear.jsp';
	var accionDescargar="getReport";
	/*
	 * Variables de Columnas
	 */
	var columnaActualizar='Actualizar';
	var linkActionColumnActualizar=basePath+"/Admin/jsp/documentosCrear.jsp?action=getDocumento&select=";
	...
	var labelFilas=new Ext.form.Label({
 		...
 		var btnDescargar = new Ext.ux.DownloadButton({
 		    ...
 		    select:'imx_catalogo_tipo_documento',
 		    nombreReporte:'Reporte Plantillas',
	...
	var Grid=new Ext.grid.Panel({
		...
		columns:[
			  ...
			  { header: tituloColumna,  dataIndex: nombreIndex, width:ancho-197 },
	...
	function Eliminar(Nombre){
		Ext.Msg.show({
		     title:'Eliminar',
		     msg: '&iquestDeseas eliminar la plantilla: '+Nombre+' ?',
