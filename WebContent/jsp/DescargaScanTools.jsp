...
<title>Utileria de digitalizacion</title>
<%
...
<!-- /Extras:Extjs -->
<!-- Aplicacion:Extjs -->
<link rel="stylesheet" type="text/css" href="../css/DescargaScanTools.css" />
<script type="text/javascript" src="../js/DescargaScanTools.js" charset="utf-8"></script>
<!-- /Aplicacion:Extjs -->
