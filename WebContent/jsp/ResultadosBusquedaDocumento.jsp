...
<div id="tableContainer" class="tableContainer"></div>
	...
	<script type="text/javascript" charset="UTF-8">
		...
		var idExp = new Array();
		var MAX_NUM_COL=5;
	    var nombre_documento = "<%=request.getParameter("nombre")%>";
	    var descripcion = "<%=request.getParameter("descripcion")%>";
	    var gaveta = "<%=request.getParameter("gaveta")%>";
	    
	    var fc1 = "<%=request.getParameter("fc1")%>";
	    var fc2 = "<%=request.getParameter("fc2")%>";
	    
	    var fm1 = "<%=request.getParameter("fm1")%>";
	    var fm2 = "<%=request.getParameter("fm2")%>";
	    
	    var fv1 = "<%=request.getParameter("fv1")%>";
	    var fv2 = "<%=request.getParameter("fv2")%>";
