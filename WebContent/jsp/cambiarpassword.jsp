...
<!-- /Extras:Extjs -->
<!-- Aplicacion:Extjs -->
<link rel="stylesheet" type="text/css" href="../css/cambiarpassword.css" />
<script type="text/javascript" src="../js/md5.js" charset="utf-8"></script>
<script type="text/javascript" src="../js/cambiarpassword.js" charset="utf-8"></script>
<!-- /Aplicacion:Extjs -->
<script type="text/javascript">
var basePath = "<%=basePath%>";
var rutaServlet = "<%=basePath%>";
rutaServlet = rutaServlet + '/Admin/OperacionesServlet';
var select="<%=u.getNombreUsuario()%>";
</script>
</head>
<body>
